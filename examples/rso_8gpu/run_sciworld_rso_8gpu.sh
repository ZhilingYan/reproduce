set -x
# ============================================================================
# RSO / ScienceWorld — recursive RSO(阶段 1,无蒸馏)  (8 GPU 版)
# ============================================================================
...
TP=${TP:-2}
OUT=${OUT:-$HOME/rso_runs/sciworld_rso}
...
python3 -m verl.trainer.main_rso_sciworld \
    ...
    trainer.experiment_name=sciworld_rso_qwen3_4b \
